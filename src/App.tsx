...
const EmbeddedPage = ({
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white border border-gray-100 rounded-2xl shadow-sm px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Embedded in the TraceWall-HK workspace shell
            </p>
          </div>
        </div>
...
export default function App() {
  ...
  const [activeNav, setActiveNav] = useState<ActiveNav>('projects');
      ...
      <header className="bg-white border-b border-gray-100 px-8 py-4 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-12">
          <button
            ...
            onClick={() => openEmbeddedView('home', 'home')}
          >
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              © 2024 TraceWall-HK. Professional circular economy tracking for the
              built environment.
            </p>
          </div>
